import {
  ...
  animate,
  style
} from "./chunk-NUJ7K3UK.js";
import {
  isPlatformBrowser
} from "./chunk-Z7H3M57M.js";
import {
  ApplicationRef,
  ...
  ViewContainerRef,
  ɵɵdefineInjectable
} from "./chunk-4MAK35TH.js";
import {
  animationFrameScheduler,
  fromEvent,
  merge
} from "./chunk-X7HWJPKU.js";
import {
  Subject,
  __assign,
  __values,
...
var Trigger = (
  /** @class */
  function() {
    function Trigger2(open, close) {
      this.open = open;
      this.close = close || open;
    }
    Trigger2.prototype.isManual = /**
    * @return {?}
    */
    function() {
...
var LinkedList = (
  ...
  function() {
    ...
    */
    ...
    LinkedList2.prototype.toArray = /**
    * @return {?}
    */
    function() {
      return this.asArray;
    };
    LinkedList2.prototype.findAll = /* tslint:disable-next-line: no-any*/
    /**
     * @param {?} fn
     * @return {?}
     */
    ...
    LinkedList2.prototype.push = // Array methods overriding start
    /**
     * @param {...?} args
     * @return {?}
     */
    ...
    */
    ...
    LinkedList2.prototype.forEach = /* tslint:disable-next-line: no-any*/
    /**
     * @param {?} fn
     * @return {?}
     */
    ...
    */
    ...
    LinkedList2.prototype.some = /* tslint:disable-next-line: no-any*/
    /**
     * @param {?} fn
     * @return {?}
     */
    ...
    LinkedList2.prototype.every = /* tslint:disable-next-line: no-any*/
    /**
     * @param {?} fn
     * @return {?}
     */
    ...
    LinkedList2.prototype.toString = /**
    * @return {?}
    */
    function() {
      return "[Linked List]";
    };
    LinkedList2.prototype.find = /* tslint:disable-next-line: no-any*/
    /**
     * @param {?} fn
     * @return {?}
     */
    ...
    LinkedList2.prototype.findIndex = /* tslint:disable-next-line: no-any*/
    /**
     * @param {?} fn
     * @return {?}
     */
    ...
    LinkedList2.prototype.getNode = /* tslint:disable-next-line: no-any*/
    /**
     * @protected
     * @param {?} position
     * @return {?}
    ...
    LinkedList2.prototype.createInternalArrayRepresentation = /**
    * @protected
    * @return {?}
    */
    function() {
...
var Utils = (
  ...
  function() {
    ...
    Utils2.reflow = /* tslint:disable-next-line: no-any */
    /**
     * @param {?} element
     * @return {?}
     */
    ...
    Utils2.getStyles = // source: https://github.com/jquery/jquery/blob/master/src/css/var/getStyles.js
...
var isIE11 = isBrowser && !!/** @type {?} */
(window.MSInputMethodContext && /** @type {?} */
document.documentMode);
var isIE10 = isBrowser && !!/** @type {?} */
...
function computeAutoPlacement(placement, refRect, target, host, allowedPositions, boundariesElement, padding) {
  ...
  var sortedAreas = Object.keys(rects).map(
    ...
    */
    function(key) {
      return __assign(__assign({ key }, rects[key]), { area: getArea(rects[key]) });
    }
  ).sort(
    /**
    * @param {?} a
...
function arrow(data) {
  ...
  if (data.offsets.host[opSide] - arrowElementSize < /** @type {?} */
  targetOffsets[side]) {
    /** @type {?} */
    targetOffsets[side] -= /** @type {?} */
    targetOffsets[side] - (data.offsets.host[opSide] - arrowElementSize);
  }
  if (Number(
    /** @type {?} */
    data.offsets.host[side]
  ) + Number(arrowElementSize) > /** @type {?} */
  targetOffsets[opSide]) {
    /** @type {?} */
    targetOffsets[side] += Number(
      /** @type {?} */
      data.offsets.host[side]
    ) + Number(arrowElementSize) - Number(
      /** @type {?} */
      targetOffsets[opSide]
    );
  }
  ...
  var sideValue = center - /** @type {?} */
  targetOffsets[side] - targetMarginSide - targetBorderSide;
  sideValue = Math.max(Math.min(targetOffsets[len] - arrowElementSize, sideValue), 0);
  data.offsets.arrow = (_a = {}, _a[side] = Math.round(sideValue), _a[altSide] = "", _a);
    ...
    primary: (
      ...
      */
      function(placement) {
        ...
        if (
          /** @type {?} */
          data.offsets.target[placement] < boundaries[placement] && true
        ) {
          value = Math.max(
            /** @type {?} */
            data.offsets.target[placement],
        ...
        return _a2 = {}, _a2[placement] = value, _a2;
      }
    ),
    secondary: (
      /**
      ...
      */
      function(placement) {
        ...
        return _a2 = {}, _a2[mainSide] = value, _a2;
      }
    )
  };
  var side;
  order.forEach(
    ...
    */
    function(placement) {
      ...
      data.offsets.target = __assign(
        __assign({}, data.offsets.target),
        /** @type {?} */
...
function shift(data) {
  ...
  if (shiftVariation) {
    ...
    data.offsets.target = __assign(__assign({}, target), (_c = {}, _c[side] = side === shiftVariation ? (
      /** @type {?} */
...
var Positioning = (
  ...
  function() {
    ...
    Positioning2.prototype.position = /**
    * @param {?} hostElement
    * @param {?} targetElement
    * @param {?=} round
    * @return {?}
    ...
    */
    ...
    Positioning2.prototype.positionElements = /**
    * @param {?} hostElement
    * @param {?} targetElement
    * @param {?} position
    * @param {?=} appendToBody
...
var PositioningService = (
  /** @class */
  function() {
    function PositioningService2(ngZone, rendererFactory, platformId) {
      var _this = this;
    ...
    PositioningService2.prototype.position = /**
    * @param {?} options
    * @return {?}
    */
    function(options) {
    ...
    Object.defineProperty(PositioningService2.prototype, "event$", {
      get: (
        /**
        * @return {?}
        */
    ...
    PositioningService2.prototype.disable = /**
    * @return {?}
    */
    function() {
      this.isDisabled = true;
    };
    PositioningService2.prototype.enable = /**
    * @return {?}
    */
    function() {
      this.isDisabled = false;
    };
    PositioningService2.prototype.addPositionElement = /**
    * @param {?} options
    * @return {?}
    */
    function(options) {
    ...
    PositioningService2.prototype.calcPosition = /**
    * @return {?}
    */
    function() {
      this.update$$.next();
    };
    PositioningService2.prototype.deletePositionElement = /**
    * @param {?} elRef
    * @return {?}
    */
    function(elRef) {
    ...
    PositioningService2.prototype.setOptions = /**
    * @param {?} options
    * @return {?}
    */
    function(options) {
    ...
    PositioningService2.decorators = [
      { type: Injectable }
    ];
    PositioningService2.ctorParameters = function() {
      return [
        { type: NgZone },
...
var BsComponentRef = (
  /** @class */
  function() {
    function BsComponentRef2() {
    }
    return BsComponentRef2;
  }()
);
if (false) {
...
var ContentRef = (
  /** @class */
  function() {
    function ContentRef2(nodes, viewRef, componentRef) {
      this.nodes = nodes;
...
var ComponentLoader = (
  /** @class */
  function() {
    function ComponentLoader2(_viewContainerRef, _renderer, _elementRef, _injector, _componentFactoryResolver, _ngZone, _applicationRef, _posService) {
    ...
    Object.defineProperty(ComponentLoader2.prototype, "isShown", {
      get: (
        /**
        * @return {?}
        */
    ...
    ComponentLoader2.prototype.attach = /**
    * @param {?} compType
    * @return {?}
    */
    function(compType) {
    ...
    ComponentLoader2.prototype.to = // todo: add behaviour: to target element, `body`, custom element
    /**
     * @param {?=} container
     * @return {?}
     */
    ...
    ComponentLoader2.prototype.position = /**
    * @param {?=} opts
    * @return {?}
    */
    function(opts) {
      this.attachment = opts.attachment || this.attachment;
      this._elementRef = /** @type {?} */
      opts.target || this._elementRef;
      return this;
    };
    ComponentLoader2.prototype.provide = /**
    * @param {?} provider
    * @return {?}
    */
    function(provider) {
    ...
    ComponentLoader2.prototype.show = // todo: appendChild to element or document.querySelector(this.container)
    /**
     * @param {?=} opts
     * @return {?}
     */
    ...
    ComponentLoader2.prototype.hide = /**
    * @param {?=} id
    * @return {?}
    */
    function(id) {
    ...
    ComponentLoader2.prototype.toggle = /**
    * @return {?}
    */
    function() {
      if (this.isShown) {
    ...
    ComponentLoader2.prototype.dispose = /**
    * @return {?}
    */
    function() {
      if (this.isShown) {
    ...
    ComponentLoader2.prototype.listen = /**
    * @param {?} listenOpts
    * @return {?}
    */
    function(listenOpts) {
    ...
    ComponentLoader2.prototype._removeGlobalListener = /**
    * @return {?}
    */
    function() {
    ...
    ComponentLoader2.prototype.attachInline = /**
    * @param {?} vRef
    * @param {?} template
    * @return {?}
    */
    ...
    ComponentLoader2.prototype._registerOutsideClick = /**
    * @return {?}
    */
    function() {
      var _this = this;
    ...
    ComponentLoader2.prototype.getInnerComponent = /**
    * @return {?}
    */
    function() {
      return this._innerComponent;
    };
    ComponentLoader2.prototype._subscribePositioning = /**
    * @private
    * @return {?}
    */
    function() {
    ...
    ComponentLoader2.prototype._unsubscribePositioning = /**
    * @private
    * @return {?}
    */
    function() {
    ...
    ComponentLoader2.prototype._getContentRef = /**
    * @private
    * @param {?} content
    * @param {?=} context
    * @param {?=} initialState
...
var ComponentLoaderFactory = (
  /** @class */
  function() {
    function ComponentLoaderFactory2(_componentFactoryResolver, _ngZone, _injector, _posService, _applicationRef) {
      this._componentFactoryResolver = _componentFactoryResolver;
      this._ngZone = _ngZone;
      this._injector = _injector;
      this._posService = _posService;
    ...
    ComponentLoaderFactory2.prototype.createLoader = /**
    *
    * @template T
    * @param {?} _elementRef
    ...
    */
    ...
    ComponentLoaderFactory2.decorators = [
      { type: Injectable }
    ];
    ComponentLoaderFactory2.ctorParameters = function() {
      return [
    ...
    return ComponentLoaderFactory2;
  }()
);
if (false) {
...
var BsDropdownConfig = (
  /** @class */
  function() {
    function BsDropdownConfig2() {
      this.autoClose = true;
      this.insideClick = false;
      this.isAnimated = false;
    }
    BsDropdownConfig2.decorators = [
      { type: Injectable, args: [{
        providedIn: "root"
      }] }
    ];
    BsDropdownConfig2.ɵprov = ɵɵdefineInjectable({ factory: function BsDropdownConfig_Factory() {
      return new BsDropdownConfig2();
    }, token: BsDropdownConfig2, providedIn: "root" });
    return BsDropdownConfig2;
  }()
);
if (false) {
...
var BsDropdownState = (
  ...
  function() {
    ...
    BsDropdownState2.decorators = [
      { type: Injectable }
    ];
    BsDropdownState2.ctorParameters = function() {
      return [];
    };
    return BsDropdownState2;
  }()
);
if (false) {
...
var BsDropdownContainerComponent = (
  /** @class */
  function() {
    function BsDropdownContainerComponent2(_state, cd, _renderer, _element, _builder) {
      var _this = this;
      this._state = _state;
      this.cd = cd;
      this._renderer = _renderer;
        ...
        */
        function(value) {
          ...
          if (dropdown && _this._state.isAnimated) {
            _this._factoryDropDownAnimation.create(dropdown).play();
          }
    ...
    Object.defineProperty(BsDropdownContainerComponent2.prototype, "direction", {
      get: (
        /**
        * @return {?}
        */
    ...
    BsDropdownContainerComponent2.prototype._contains = /**
    * \@internal
    * @param {?} el
    * @return {?}
    */
    ...
    BsDropdownContainerComponent2.prototype.ngOnDestroy = /**
    * @return {?}
    */
    function() {
      this._subscription.unsubscribe();
    };
    BsDropdownContainerComponent2.decorators = [
      { type: Component, args: [{
  ...
  `
    ...
    BsDropdownContainerComponent2.ctorParameters = function() {
      return [
    ...
    return BsDropdownContainerComponent2;
  }()
);
if (false) {
...
var BsDropdownDirective = (
  /** @class */
  function() {
    function BsDropdownDirective2(_elementRef, _renderer, _viewContainerRef, _cis, _state, _config, _builder) {
      this._elementRef = _elementRef;
      this._renderer = _renderer;
      this._viewContainerRef = _viewContainerRef;
      this._cis = _cis;
      ...
      this._factoryDropDownAnimation = _builder.build(dropdownAnimation);
      this._dropdown = this._cis.createLoader(this._elementRef, this._viewContainerRef, this._renderer).provide({ provide: BsDropdownState, useValue: this._state });
      this.onShown = this._dropdown.onShown;
      this.onHidden = this._dropdown.onHidden;
      this.isOpenChange = this._state.isOpenChange;
    }
    Object.defineProperty(BsDropdownDirective2.prototype, "autoClose", {
      get: (
        /**
        * @return {?}
        */
    ...
    Object.defineProperty(BsDropdownDirective2.prototype, "isAnimated", {
      get: (
        /**
        * @return {?}
        */
    ...
    Object.defineProperty(BsDropdownDirective2.prototype, "insideClick", {
      get: (
        /**
        * @return {?}
        */
    ...
    Object.defineProperty(BsDropdownDirective2.prototype, "isDisabled", {
      get: (
        /**
        * @return {?}
        */
    ...
    Object.defineProperty(BsDropdownDirective2.prototype, "isOpen", {
      /**
    ...
    Object.defineProperty(BsDropdownDirective2.prototype, "isBs4", {
      get: (
        /**
        * @return {?}
        */
    ...
    Object.defineProperty(BsDropdownDirective2.prototype, "_showInline", {
      get: (
        /**
        * @private
        * @return {?}
    ...
    BsDropdownDirective2.prototype.ngOnInit = /**
    * @return {?}
    */
    function() {
      var _this = this;
    ...
    BsDropdownDirective2.prototype.show = /**
    ...
    */
    function() {
      ...
      this._state.dropdownMenu.then(
        ...
        */
        function(dropdownMenu) {
          var _dropup = _this.dropup || typeof _this.dropup !== "undefined" && _this.dropup;
          _this._state.direction = _dropup ? "up" : "down";
          var _placement = _this.placement || (_dropup ? "top start" : "bottom start");
          _this._dropdown.attach(BsDropdownContainerComponent).to(_this.container).position({ attachment: _placement }).show({
    ...
    BsDropdownDirective2.prototype.hide = /**
    ...
    */
    ...
    BsDropdownDirective2.prototype.toggle = /**
    ...
    */
    ...
    BsDropdownDirective2.prototype._contains = /**
    * \@internal
    * @param {?} event
    * @return {?}
    */
    ...
    BsDropdownDirective2.prototype.ngOnDestroy = /**
    * @return {?}
    */
    function() {
      var e_1, _a;
    ...
    BsDropdownDirective2.prototype.addBs4Polyfills = /**
    * @private
    * @return {?}
    */
    function() {
    ...
    BsDropdownDirective2.prototype.playAnimation = /**
    * @private
    * @return {?}
    */
    function() {
    ...
    BsDropdownDirective2.prototype.addShowClass = /**
    * @private
    * @return {?}
    */
    function() {
    ...
    BsDropdownDirective2.prototype.removeShowClass = /**
    * @private
    * @return {?}
    */
    function() {
    ...
    BsDropdownDirective2.prototype.checkRightAlignment = /**
    * @private
    * @return {?}
    */
    function() {
    ...
    BsDropdownDirective2.prototype.addDropupStyles = /**
    * @private
    * @return {?}
    */
    function() {
    ...
    BsDropdownDirective2.prototype.removeDropupStyles = /**
    * @private
    * @return {?}
    */
    function() {
    ...
    BsDropdownDirective2.decorators = [
      { type: Directive, args: [{
    ...
    BsDropdownDirective2.ctorParameters = function() {
      return [
        { type: ElementRef },
        { type: Renderer2 },
    ...
    BsDropdownDirective2.propDecorators = {
...
var BsDropdownMenuDirective = (
  /** @class */
  function() {
    function BsDropdownMenuDirective2(_state, _viewContainer, _templateRef) {
      _state.resolveDropdownMenu({
        templateRef: _templateRef,
        viewContainer: _viewContainer
      });
    }
    BsDropdownMenuDirective2.decorators = [
      { type: Directive, args: [{
        selector: "[bsDropdownMenu],[dropdownMenu]",
        exportAs: "bs-dropdown-menu"
      }] }
    ];
    BsDropdownMenuDirective2.ctorParameters = function() {
      return [
        { type: BsDropdownState },
        { type: ViewContainerRef },
        { type: TemplateRef }
    ...
    return BsDropdownMenuDirective2;
  }()
);
var BsDropdownToggleDirective = (
  /** @class */
  function() {
    function BsDropdownToggleDirective2(_changeDetectorRef, _dropdown, _element, _renderer, _state) {
      var _this = this;
      ...
      this._subscriptions.push(this._state.isOpenChange.subscribe(
        ...
        */
        function(value) {
          _this.isOpen = value;
          if (value) {
            _this._documentClickListener = _this._renderer.listen(
              "document",
              "click",
              /**
              * @param {?} event
              ...
              */
              function(event) {
                if (_this._state.autoClose && event.button !== 2 && !_this._element.nativeElement.contains(event.target) && !(_this._state.insideClick && _this._dropdown._contains(event))) {
                  _this._state.toggleClick.emit(false);
                  _this._changeDetectorRef.detectChanges();
                }
              }
            );
            _this._escKeyUpListener = _this._renderer.listen(
              _this._element.nativeElement,
              "keyup.esc",
              /**
              * @return {?}
              */
    ...
    BsDropdownToggleDirective2.prototype.onClick = /**
    * @return {?}
    */
    function() {
      if (this.isDisabled) {
    ...
    BsDropdownToggleDirective2.prototype.ngOnDestroy = /**
    * @return {?}
    */
    function() {
      var e_1, _a;
    ...
    BsDropdownToggleDirective2.decorators = [
      { type: Directive, args: [{
    ...
    BsDropdownToggleDirective2.ctorParameters = function() {
      return [
        { type: ChangeDetectorRef },
    ...
    BsDropdownToggleDirective2.propDecorators = {
      isDisabled: [{ type: HostBinding, args: ["attr.disabled"] }],
      isOpen: [{ type: HostBinding, args: ["attr.aria-expanded"] }],
      onClick: [{ type: HostListener, args: ["click", []] }]
    };
    return BsDropdownToggleDirective2;
  }()
);
if (false) {
...
var BsDropdownModule = (
  /** @class */
  function() {
    function BsDropdownModule2() {
    }
    BsDropdownModule2.forRoot = // tslint:disable-next-line:no-any
    /**
     * @param {?=} config
     * @return {?}
     */
...
ngx-bootstrap/utils/fesm5/ngx-bootstrap-utils.js:
  (**
   * @license
   ...
   *)
*/
//# sourceMappingURL=chunk-7O4EOXY2.js.map
